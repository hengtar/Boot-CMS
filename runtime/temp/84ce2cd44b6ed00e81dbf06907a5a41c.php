<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"C:\Users\Administrator\Desktop\Project\boot-cms-test\public/../application/admin\view\login.html";i:1507777258;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
    <title>Boot-Z cms后台管理系统</title>
...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            <form method="post" action="<?php echo url('admin/Login/login'); ?>" id="doLogin">
                ...
                <p class="m-t-md">登录到Boot-Z cms后台管理系统</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2015 All Rights Reserved. Boot-Z cms 后台管理系统
        </div>
    </div>
</div>
</body>
