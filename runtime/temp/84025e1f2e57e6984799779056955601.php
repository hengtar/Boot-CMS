                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Article/insertArticle'); ?>"><button class="btn btn-outline btn-success" type="button">添加文章</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            layer.confirm('确认删除此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Article/deleteArticle'); ?>",
        ...
        $('.statusArtciel').click(function(){
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Article/statusArticle'); ?>",
        ...
        $('.isTuiArtciel').click(function(){
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Article/isTuiArticle'); ?>",
