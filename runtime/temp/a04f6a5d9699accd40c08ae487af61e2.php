        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertArticle" action="<?php echo url('Article/insert_article'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站标题" name="title" id="title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站关键词" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 100px" placeholder="输入网站描述" name="description"  id="description"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站备案号" name="title" id="beian">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 100px" placeholder="输入站长统计代码" name="tongji"  id="tongji"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
