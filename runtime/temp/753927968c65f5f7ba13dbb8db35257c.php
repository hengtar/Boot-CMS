            ...
            <div class="col-md-7 text-left">
                <div class="display-t">
                    <div class="display-tc animate-box" data-animate-effect="fadeInUp">
                        <h1 class="mb30"><?php echo $article['title']; ?></h1>
                        <p>
                            <a class="btn btn-primary"><?php echo $article['description']; ?></a>
                        </p>
                    </div>
                </div>
            </div>
