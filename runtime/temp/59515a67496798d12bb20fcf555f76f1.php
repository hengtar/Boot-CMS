<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\Users\starwork\Desktop\20170818\blog\public/../application/admin\view\login.html";i:1502343534;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script>
    $(function () {
        ...
        function LoginOk(data) {
            if (data.pass == 1){
                $('#logincss').html("<button class='btn btn-danger btn-block'>验证成功</button>")
