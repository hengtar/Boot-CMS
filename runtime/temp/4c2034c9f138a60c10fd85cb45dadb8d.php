<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/template/list_template.html";i:1524030307;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Template/insert_Template'); ?>"><button class="btn btn-outline btn-success" type="button">添加模板</button></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                ...
                                <?php if(($list['id'] == 1) OR ($list['id'] == 2) OR ($list['id'] == 3) OR ($list['id'] == 4) OR ($list['id'] == 5)OR ($list['id'] == 6)OR ($list['id'] == 7)): ?>
                                不可操作
                                <?php else: ?>
                                <a  class="btn btn-primary btn-outline btn-xs" href="<?php echo url('Template/update_Template',array('id' => $list['id'])); ?>">
    ...
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            layer.confirm('确认删除此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Template/delete_Template'); ?>",
        ...
        $('.statusArtciel').click(function(){
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Template/status_Template'); ?>",
        ...
        $('.isTuiArtciel').click(function(){
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Template/isTui_Template'); ?>",
