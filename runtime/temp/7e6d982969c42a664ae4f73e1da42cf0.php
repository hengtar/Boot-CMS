<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/article/list_article.html";i:1524030304;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-2" style="width: 100px">
                        <div class="input-group">
                            <a href="<?php echo url('Article/insert_article'); ?>">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                <a class="btn btn-primary btn-outline btn-xs"
                                   href="<?php echo url('article/update_article',array('id' => $list['id'])); ?>">
    ...
    $(function () {
        ...
        $('.delArtciel').click(function () {
            ...
            layer.confirm('确认删除此文章?',
                {icon: 3, title: '提示'},
                function (index) {
                    $.getJSON("<?php echo url('Article/delete_article'); ?>",
        ...
        $('.statusArtciel').click(function () {
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title: '提示'},
                function (index) {
                    $.getJSON("<?php echo url('Article/status_article'); ?>",
        ...
        $('.isTuiArtciel').click(function () {
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title: '提示'},
                function (index) {
                    $.getJSON("<?php echo url('Article/isTui_article'); ?>",
