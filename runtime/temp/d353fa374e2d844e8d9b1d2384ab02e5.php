        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertMember"
                          action="<?php echo url('Member/update_member'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">用户名：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入用户名" name="username"
                                       id="username" value="<?php echo $member['account']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control m-b" name="cate_id" id="cate_id">
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$list): if($member['cate_id'] == $list['id']): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="photo" value="<?php if(empty($member['photo']) || (($member['photo'] instanceof \think\Collection || $member['photo'] instanceof \think\Paginator ) && $member['photo']->isEmpty())): ?>/static/webupload/no_img.jpg<?php else: ?><?php echo $member['photo']; endif; ?>">
                                ...
                                <img id="img_data" height="100px"
                                   ...
                                   <?php if(empty($member['photo']) || (($member['photo'] instanceof \think\Collection || $member['photo'] instanceof \think\Paginator ) && $member['photo']->isEmpty())): ?>
                                /static/webupload/no_img.jpg
                                <?php else: ?>
                                /uploads/images/<?php echo $member['photo']; endif; ?>
                                "/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
