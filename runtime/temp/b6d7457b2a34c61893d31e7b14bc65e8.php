<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/data/wwwroot/default/thinkphp/public/../application/admin/view/menu/list_menu.html";i:1503989205;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                            ...
                            <?php if(is_array($listRule) || $listRule instanceof \think\Collection || $listRule instanceof \think\Paginator): if( count($listRule)==0 ) : echo "" ;else: foreach($listRule as $key=>$listRule): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="<?php echo url('Menu/update_menu',array('id' => $listRule['id'])); ?>" class="btn btn-primary btn-outline btn-xs">
    ...
    $(function(){
        ...
        $('.delMenu').click(function(){
            ...
            layer.confirm('确认删除此菜单?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Menu/delete_menu'); ?>",
