<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"C:\Users\Administrator\Desktop\Project\blog\public/../application/admin\view\nav\listnav.html";i:1500454341;s:93:"C:\Users\Administrator\Desktop\Project\blog\public/../application/admin\view\public\head.html";i:1500454344;s:92:"C:\Users\Administrator\Desktop\Project\blog\public/../application/admin\view\public\css.html";i:1500454342;s:91:"C:\Users\Administrator\Desktop\Project\blog\public/../application/admin\view\public\js.html";i:1500454342;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Nav/insertNav'); ?>"><button class="btn btn-outline btn-success" type="button">添加菜单</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td style="text-align: left"><?php echo $list['lefthtml']; ?><?php echo $list['cate_name']; ?></td>
                            ...
                            <td>
                                ...
                                <?php else: if(empty($list['content']) || (($list['content'] instanceof \think\Collection || $list['content'] instanceof \think\Paginator ) && $list['content']->isEmpty())): ?>
                                    <a href="<?php echo url('Nav/insertPage',array('id' => $list['id'])); ?>" class="btn btn-info  btn-xs">
                                        <i class="fa fa-hand-lizard-o"></i>
                                        上传
                                    </a>&nbsp;&nbsp;

                                    <?php else: ?>
                                    <a href="<?php echo url('Nav/insertPage',array('id' => $list['id'])); ?>" class="btn btn-success  btn-xs">
                                        <i class="fa fa-hand-lizard-o"></i>
                                        更新
                                    </a>&nbsp;&nbsp;
                                    <?php endif; endif; ?>
                            ...
                            <td>
                                <a href="<?php echo url('Nav/updateNav',array('id' => $list['id'])); ?>" class="btn btn-success btn-outline btn-xs">
    ...
    $(function(){
        ...
        $('.laozhang').click(function(){
            ...
            layer.confirm('确认删除此分类?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Nav/deleteNav'); ?>",
        ...
        $('.status').click(function(){
            ...
            layer.confirm('确认更改此分类?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Nav/statusNav'); ?>",
