<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/article/update_article.html";i:1524030305;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertArticle" action="<?php echo url('Article/update_article'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入文章标题" name="title" id="title" value="<?php echo $article['title']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入文章关键词" name="keywords" id="keywords" value="<?php echo $article['keywords']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 100px" placeholder="输入文章描述" name="description"  id="description"><?php echo $article['description']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control m-b" name="cate_id" id="cate_id">
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$list): if($article['cate_id'] == $list['id']): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="photo" value="<?php if(empty($article['photo']) || (($article['photo'] instanceof \think\Collection || $article['photo'] instanceof \think\Paginator ) && $article['photo']->isEmpty())): ?>/static/webupload/no_img.jpg<?php else: ?><?php echo $article['photo']; endif; ?>">
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="float:left">选择图片</div>
                                <img id="img_data" height="100px"
                                     style="float:left;margin-left: 80px;margin-top: -10px;" src="
                                   <?php if(empty($article['photo']) || (($article['photo'] instanceof \think\Collection || $article['photo'] instanceof \think\Paginator ) && $article['photo']->isEmpty())): ?>
                                /static/webupload/no_img.jpg
                                <?php else: ?>
                                /uploads/images/<?php echo $article['photo']; endif; ?>
                                "/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-9">
                                ...
                                <textarea name="content" style="width:90%;height: 450px"  id="Editor"><?php echo $article['content']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="views" placeholder="100-10000数值" id="views" value="<?php echo $article['views']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="author" placeholder="作者信息" id="author" value="<?php echo $article['author']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
        ...
        function insertOk(data){
            if (data.pass == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('Article/list_article'); ?>";
                });
            }else{
