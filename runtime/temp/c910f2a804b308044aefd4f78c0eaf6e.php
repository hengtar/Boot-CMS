                ...
                <div class="ibox-content">
                    <form id="insertCate" method="post" class="form-horizontal" action="<?php echo url('Member/update_cate'); ?>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="cate_name" id="cate_name" class="form-control" placeholder="输入类型名称" value="<?php echo $cate['cate_name']; ?>">
                            </div>
                        </div>
