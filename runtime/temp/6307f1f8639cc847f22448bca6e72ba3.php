<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/menu_home/list_menu.html";i:1524038846;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('menu_home/insert_menu'); ?>"><button class="btn btn-outline btn-success" type="button">添加菜单</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td><?php echo $list['template_link']; ?></td>
                            ...
                            <td>
                                <?php if(($list['template_cate'] == 5)): if(empty($list['content']) || (($list['content'] instanceof \think\Collection || $list['content'] instanceof \think\Paginator ) && $list['content']->isEmpty())): ?>
                                <a href="<?php echo url('MenuHome/insert_page',array('id' => $list['id'])); ?>" class="btn btn-info  btn-xs">
                                    <i class="fa fa-hand-lizard-o"></i>
                                    上传
                                </a>&nbsp;&nbsp;

                                <?php else: ?>
                                <a href="<?php echo url('MenuHome/insert_page',array('id' => $list['id'])); ?>" class="btn btn-success  btn-xs">
                                    <i class="fa fa-hand-lizard-o"></i>
                                    更新
                                </a>&nbsp;&nbsp;
                                <?php endif; else: ?>
                                <?php echo $list['cate_name']; endif; ?>

                            </td>
                            <td>
                                <a href="<?php echo url('menu_home/update_menu',array('id' => $list['id'])); ?>" class="btn btn-success btn-outline btn-xs">
    ...
    $(function(){
        ...
        $('.laozhang').click(function(){
            ...
            layer.confirm('确认删除此分类?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('menu_home/delete_menu'); ?>",
        ...
        $('.status').click(function(){
            ...
            layer.confirm('确认更改此分类?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('menu_home/status_menu'); ?>",
