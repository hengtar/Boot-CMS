<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"/data/wwwroot/default/thinkphp/public/../application/index/view/article/index.html";i:1504247770;s:79:"/data/wwwroot/default/thinkphp/public/../application/index/view/public/css.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/index/view/public/nav.html";i:1503989206;s:80:"/data/wwwroot/default/thinkphp/public/../application/index/view/public/foot.html";i:1503990629;s:78:"/data/wwwroot/default/thinkphp/public/../application/index/view/public/js.html";i:1503989206;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="text-left content-article">
                            <div class="row">
                                <div class="col-lg-12 cp-r animate-box">
                                    ...
                                    <p style="text-align: center">本文来源：老张 博客 &nbsp; &nbsp;&nbsp;责任编辑：老张</p>
                            ...
                            <script type="text/javascript">
                                (function(){
                                    var appid = 'cytbGUGgz';
                                    var conf = '977a2d740cb89f0ad9ba4219aed46841';
            ...
            <div class="row row-pb-md">
                <div class="col-md-12">
                    <ul id="gtco-post-list">
                        <?php if(is_array($SuiJi) || $SuiJi instanceof \think\Collection || $SuiJi instanceof \think\Paginator): if( count($SuiJi)==0 ) : echo "" ;else: foreach($SuiJi as $key=>$SuiJi): ?>
                            <li class="one-third animate-box entry" data-animate-effect="fadeIn">
                                <a href="#">
                                    <div class="entry-img" style="background-image: url(/uploads/images/<?php echo str_replace('\\','/',$SuiJi['photo']); ?>)"></div>
                                    <div class="entry-desc">
                                        <h3><?php echo msubstr($SuiJi['title'],0,15); ?></h3>
                                        <p><?php echo msubstr($SuiJi['description'],0,30); ?></p>
                                    </div>
                                </a>
    ...
    <div class="container">
        ...
        <div class="row copyright">
            <div class="col-md-12 text-center">
                <p>
                    <small class="block"><?php echo $config['web_author']; ?><a href="http://www.jh12.cn/" target="_blank" title="老张博客">老张博客</a></small>
                </p>
                <p>
                    <small class="block">备案号 ：
                        <a href="http://www.miitbeian.gov.cn/" target="_blank" title="<?php echo $config['web_icp']; ?>"><?php echo $config['web_icp']; ?></a></small>
                </p>
                <p>
