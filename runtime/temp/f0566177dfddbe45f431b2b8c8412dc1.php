<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/config/seo.html";i:1503989205;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="updateConfig" action="<?php echo url('Config/seo'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站标题" name="config[web_title]" id="web_title" value="<?php echo $config['web_title']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站关键词" name="config[web_keywords]" id="web_keywords" value="<?php echo $config['web_keywords']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 100px" placeholder="输入网站描述" name="config[web_description]"  id="web_description" ><?php echo $config['web_description']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                ...
                                <?php if(empty($config['web_logo']) || (($config['web_logo'] instanceof \think\Collection || $config['web_logo'] instanceof \think\Paginator ) && $config['web_logo']->isEmpty())): ?>
                                <img id="img_data" height="100px" style="float:left;margin-left: 80px;margin-top: -10px;" src="/static/webupload/no_img.jpg"/>
                                <?php else: ?>
                                <img id="img_data" height="100px" style="float:left;margin-left: 80px;margin-top: -10px;" src="/uploads/images/<?php echo $config['web_logo']; ?>"/>
                                <input type="hidden" name="data_photo" value="<?php echo $config['web_logo']; ?>">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站备案号" name="config[web_icp]" id="web_icp" value="<?php echo $config['web_icp']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 150px" placeholder="输入站长统计代码" name="config[web_statis]"  id="web_statis"><?php echo $config['web_statis']; ?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入网站版权信息" name="config[web_author]" id="web_author" value="<?php echo $config['web_author']; ?>">
        ...
        function insertOk(data){
            if (data.pass == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('Config/seo'); ?>";
                });
            }else{
