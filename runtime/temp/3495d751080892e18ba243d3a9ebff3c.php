        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="insertCate" method="post" class="form-horizontal" action="<?php echo url('product/insert_cate'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">所属父级：</label>
                            <div class="col-sm-4">
                                <select class="form-control m-b" name="p_id">
                                    <option value="0">顶级</option>
                                    <?php if(is_array($product_cate) || $product_cate instanceof \think\Collection || $product_cate instanceof \think\Paginator): if( count($product_cate)==0 ) : echo "" ;else: foreach($product_cate as $key=>$product_cate): ?>
                                        <option value="<?php echo $product_cate['id']; ?>"><?php echo $product_cate['lefthtml']; ?><?php echo $product_cate['name']; ?></option>
        ...
        function insertOk(data){
                if (data.pass == 1){
                    layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                        window.location.href="<?php echo url('product/list_cate'); ?>";
                    });
                }else{
