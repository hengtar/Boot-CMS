                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Advert/insertAdvert'); ?>"><button class="btn btn-outline btn-success" type="button">添加广告</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            layer.confirm('确认删除此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/deleteAdvert'); ?>",
        ...
        $('.statusArtciel').click(function(){
            ...
            layer.confirm('确认更改此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/statusAdvert'); ?>",
        ...
        $('.isTuiArtciel').click(function(){
            ...
            layer.confirm('确认更改此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/isTuiAdvert'); ?>",
