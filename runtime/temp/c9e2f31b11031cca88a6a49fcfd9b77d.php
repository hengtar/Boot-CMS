...
<meta name="description" content="<?php echo $config['web_title']; ?>-<?php echo $MenuInfo['description']; ?>" />
            ...
            <div class="col-md-7 text-left">
                <div class="display-t">
                    <div class="display-tc animate-box" data-animate-effect="fadeInUp">
                        <h1 class="mb30"><?php echo $MenuInfo['name']; ?></h1>
                        <p>
                            <a class="btn btn-primary"><?php echo $MenuInfo['description']; ?></a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-md-8 col-md-offset-2 text-left fh5co-heading  animate-box">
                ...
                <h2><?php echo $MenuInfo['name']; ?></h2>
                <p><?php echo $MenuInfo['description']; ?>.</p>
            </div>
        </div>
        <div class="row">
