        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="insertCate" method="post" class="form-horizontal" action="<?php echo url('Nav/updateNav'); ?>">
                                ...
                                <select class="form-control m-b" name="p_id">
                                    ...
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$list): ?>
                                        ...
                                        <option value="<?php echo $list['id']; ?>"
                                                ...
                                                selected="selected"
                                                <?php endif; ?>>
                                            <?php echo $list['lefthtml']; ?><?php echo $list['cate_name']; ?>
                                        </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="cate_name" id="cate_name" class="form-control" placeholder="输入分类名称" value="<?php echo $Nav['cate_name']; ?>">
                            </div>
                        </div>
