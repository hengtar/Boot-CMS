<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/wwwroot/default/thinkphp/public/../application/admin/view/advert/list_advert.html";i:1503989205;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Advert/insert_advert'); ?>"><button class="btn btn-outline btn-success" type="button">添加广告</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            layer.confirm('确认删除此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/delete_advert'); ?>",
        ...
        $('.statusArtciel').click(function(){
            ...
            layer.confirm('确认更改此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/status_advert'); ?>",
        ...
        $('.isTuiArtciel').click(function(){
            ...
            layer.confirm('确认更改此广告?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Advert/isTui_advert'); ?>",
