                ...
                <div class="ibox-content">
                    <form id="insertCate" method="post" class="form-horizontal" action="<?php echo url('Article/insertCate'); ?>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="cat_name" id="cat_name" class="form-control" placeholder="输入分类名称">
                            </div>
                        </div>
