<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/wwwroot/default/thinkphp/public/../application/admin/view/member/list_member.html";i:1503989205;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Member/insert_member'); ?>"><button class="btn btn-outline btn-success" type="button">添加会员</button></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            var $this = $(this);
            layer.confirm('确认删除此会员?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Member/delete_member'); ?>",
        ...
        $('.statusArtciel').click(function(){
            ...
            layer.confirm('确认更改此状态?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Member/status_member'); ?>",
        ...
        $('.isTuiArtciel').click(function(){
            ...
            layer.confirm('确认更改此文章?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Member/isTui_member'); ?>",
