        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="insertpage" method="post" class="form-horizontal" action="<?php echo url('Nav/insert_page'); ?>">
