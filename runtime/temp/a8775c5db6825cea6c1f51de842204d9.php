<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/menu_home/update_menu.html";i:1524030306;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="insertCate" method="post" class="form-horizontal" action="<?php echo url('menu_home/update_menu'); ?>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control m-b" name="p_id">
                                    ...
                                    <option value="<?php echo $list['id']; ?>" <?php if(($list['id'] == $Nav['p_id'])): ?> selected="selected"<?php endif; ?>><?php echo $list['lefthtml']; ?><?php echo $list['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="keywords" id="keywords" class="form-control" placeholder="输入此栏目的关键词信息" value="<?php echo $Nav['keywords']; ?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="description" id="description" class="form-control" placeholder="输入此栏目的描述信息" value="<?php echo $Nav['description']; ?>">
                            </div>
