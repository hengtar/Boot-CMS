    ...
    $(function(){
        ...
        $('.delArtciel').click(function(){
            ...
            layer.confirm('确认删除此留言?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Message/deleteMessage'); ?>",
        ...
        $('.statusMessage').click(function(){
            ...
            layer.confirm('确认更改此状态?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('Message/statusMessage'); ?>",
