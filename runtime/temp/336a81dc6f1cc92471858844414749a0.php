<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/menu_admin/list_menu.html";i:1524030306;s:78:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/head.html";i:1524030307;s:77:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/css.html";i:1524030307;s:76:"/data/wwwroot/www.boot-z.com/public/../application/admin/view/public/js.html";i:1524030307;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <tbody id="article_list">
                            <?php if(is_array($listRule) || $listRule instanceof \think\Collection || $listRule instanceof \think\Paginator): if( count($listRule)==0 ) : echo "" ;else: foreach($listRule as $key=>$listRule): ?>
                                <tr>
                                    ...
                                    <td>&nbsp; &nbsp;<?php echo $listRule['lefthtml']; ?><?php echo $listRule['name']; ?></td>
                                    <td style="text-align: center"><?php echo $listRule['url']; ?></td>
                                    <td style="text-align: center"><?php echo $listRule['update_time']; ?></td>

                                    <td style="text-align: center">
                                        <a href="<?php echo url('MenuAdmin/update_menu',array('id' => $listRule['id'])); ?>" class="btn btn-primary btn-outline btn-xs">
                                            <i class="fa fa-paste"></i> 编辑
                                        </a>
                                        &nbsp; &nbsp;
                                        <button class="btn btn-danger btn-outline btn-xs delMenu" id="del-<?php echo $listRule['id']; ?>">
...
<div class="modal  fade" id="myAuth" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" name="add_rule" id="add_rule" method="post" action="<?php echo url('insert_menu'); ?>">
                <div class="ibox-content">
    ...
    $(function(){
        ...
        $('.delMenu').click(function(){
            ...
            layer.confirm('确认删除此菜单?',
                {icon: 3, title:'提示'},
                function(index){$.getJSON("<?php echo url('MenuAdmin/delete_menu'); ?>",
