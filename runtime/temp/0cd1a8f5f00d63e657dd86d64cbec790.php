        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertproduct" action="<?php echo url('product/insert_product'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入产品标题" name="title" id="title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入产品关键词" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" style="height: 100px" placeholder="输入产品描述" name="description"  id="description"></textarea>
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">产品正文：</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-3">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="javascript:history.back(-1)" class="btn btn-danger" type="submit"><i class="fa fa-close"></i> 返 回</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    $(function () {
        ...
        $('#insertproduct').ajaxForm(opt);

        function insertBefor(){
            if ($('#title').val() == ''){
                layer.msg('产品标题不能为空',{icon:5});
                return false;
            }

            if ($('#keywords').val() == ''){
                layer.msg('产品关键词不能为空',{icon:5});
                return false;
            }

            if ($('#description').val() == ''){
                layer.msg('产品描述不能为空',{icon:5});
                return false;
            }
        ...
        function insertOk(data){
            if (data.pass == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('product/list_product'); ?>";
                });
            }else{
