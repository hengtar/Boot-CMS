<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"/data/wwwroot/www.boot-z.com/public/../application/index/view/article/lists.html";i:1524030307;s:78:"/data/wwwroot/www.boot-z.com/public/../application/index/view/public/head.html";i:1524038134;s:78:"/data/wwwroot/www.boot-z.com/public/../application/index/view/public/menu.html";i:1524030308;s:80:"/data/wwwroot/www.boot-z.com/public/../application/index/view/public/footer.html";i:1524038489;s:78:"/data/wwwroot/www.boot-z.com/public/../application/index/view/public/foot.html";i:1524030307;}*/ ?>
<!DOCTYPE html>
<html>
<title><?php echo $config['web_title']; ?>-<?php echo $SeoConfig['name']; ?></title>
        ...
        <div class="blog-pag">
            <div class="blog-page-grids">
                <div class="blog-page-grid">
                    <h3><a href="<?php echo url('article/index',array('page'=> $list['id'])); ?>"><?php echo $list['title']; ?></a></h3>
                    <!--<p>发表在 <span> </span></p>-->
                </div>
                <div class="blog-page-grid1">
                    <p><?php echo $list['views']; ?><a href="javascript:viod()"> View</a></p>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="blog-page-grids-bottom">
                <div class="blog-page-grids-bot">
                    <a href="single.html"><img src="/uploads/images/<?php echo $list['photo']; ?>" alt=" " class="img-responsive" /></a>
                </div>
                <div class="blog-page-grids-bot1">
                    <h4><?php echo $list['title']; ?></h4>
                    <p><?php echo $list['description']; ?></p>
                    <ul>
                        <li><a href="javascript:viod()"><span class="glyphicon glyphicon-tag" aria-hidden="true"></span></a><?php echo $SeoConfig['name']; ?> </li>
                        <li><a href="javascript:viod()"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span><?php echo $list['create_time']; ?></a></li>
                        <li><a href="javascript:viod()"><span class="glyphicon glyphicon-user" aria-hidden="true"></span><?php echo $list['author']; ?></a></li>
                    </ul>
                    <div class="more">
                        <a href="<?php echo url('article/index',array('page'=> $list['id'])); ?>" class="hvr-bounce-to-bottom">阅读更多</a>
                    </div>
                </div>
                <div class="clearfix"> </div>
            </div>
