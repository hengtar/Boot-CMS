                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertArticle" action="<?php echo url('Article/insert_article'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入邮件显示" name="title" id="title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入邮箱服务器地址" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入邮箱地址" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入邮箱登录账号" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入邮箱登录密码" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
