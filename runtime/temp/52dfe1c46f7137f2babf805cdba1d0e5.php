<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:74:"/data/wwwroot/default/thinkphp/public/../application/admin/view/index.html";i:1503989204;s:85:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/introduce.html";i:1503989206;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/nav.html";i:1503989206;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/foot.html";i:1503989206;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/left.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
<!DOCTYPE html>
<html>
<!--// +-->
<!--// | 作者：Boot.Z  老张-->
...
<div id="wrapper">
        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <span><img alt="image" style="width: 100px;" class="img-circle"
                               src="/uploads/images/<?php echo \think\Session::get('admin_photo'); ?>"/></span>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <br>
                                <span class="text-muted text-xs block">欢迎管理员：<?php echo \think\Session::get('admin_nickname'); ?><b
                                        class="caret"></b></span>
                                </span>
                    </a>
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        <li><a class="J_menuItem" href="<?php echo url('Config/administrator'); ?>">修改头像</a>
                        </li>
                        <li><a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=852952656&Menu=yes">联系我们</a>
                        </li>
                        <li><a target="_blank"
                               href="//shang.qq.com/wpa/qunwpa?idkey=093d1ada76c494c65607722f973524f5877c175d78796993548cf053429874ed">加入交流群</a>
                        </li>
                        <li class="divider"></li>
            ...
            <?php if(!empty($menu)): if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$menu): ?>
            <li class="menu">
                <a href="<?php echo $menu['url']; ?>">
                    <i class="<?php echo $menu['ico']; ?>"></i>
                    <span class="nav-label"><?php echo $menu['name']; ?> </span>
                    <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-second-level">
                    <?php if(!empty($menu['_child'])): if(is_array($menu['_child']) || $menu['_child'] instanceof \think\Collection || $menu['_child'] instanceof \think\Paginator): if( count($menu['_child'])==0 ) : echo "" ;else: foreach($menu['_child'] as $key=>$child): ?>
                    <li>
                        <a class="J_menuItem" href="/<?php echo $child['url']; ?>"><?php echo $child['name']; ?></a>
                    </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="hidden-xs">
                        <a href="<?php echo url('Login/loginOut'); ?>" ><i class="fa fa-outdent"></i> 注销</a>
                    </li>
        ...
        <div class="footer">
    <div class="pull-right">&copy; 2014-2015 <a href="http://www.miitbeian.gov.cn/" target="_blank">京ICP备17044002号</a>
    </div>
</div>
    </div>
    <!--右侧部分结束-->
