                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                ...
                                <?php if(($list['id'] == 1) OR ($list['id'] == 2) OR ($list['id'] == 3) OR ($list['id'] == 4) OR ($list['id'] == 5) OR ($list['id'] == 6)): ?>
                                基础模板
                                <?php else: ?>
                                <a>
