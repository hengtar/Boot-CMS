                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertArticle" action="<?php echo url('Article/insert_article'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入阿里大鱼AppKey" name="title" id="title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入阿里大鱼SecretKey" name="keywords" id="keywords">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
