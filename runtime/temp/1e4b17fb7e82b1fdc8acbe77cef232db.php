                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Article/insertCate'); ?>"><button class="btn btn-outline btn-success" type="button">添加分类</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                <a href="<?php echo url('Article/updateCate',array('id' => $list['id'])); ?>" class="btn btn-success btn-outline btn-xs">
   ...
   $(function(){
       ...
       $('.laozhang').click(function(){
           ...
           layer.confirm('确认删除此分类?',
               {icon: 3, title:'提示'},
               function(index){$.getJSON("<?php echo url('Article/deleteCate'); ?>",
       ...
       $('.status').click(function(){
           ...
           layer.confirm('确认更改此分类?',
               {icon: 3, title:'提示'},
               function(index){$.getJSON("<?php echo url('Article/statusCate'); ?>",
