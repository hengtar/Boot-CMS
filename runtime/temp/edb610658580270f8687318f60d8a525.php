                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                <a  class="btn btn-primary btn-outline btn-xs" href="<?php echo url('article/update_article',array('id' => $list['id'])); ?>">
