<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:106:"C:\Users\Administrator\Desktop\Project\boot_cms\public/../application/admin\view\advert\update_advert.html";i:1505965573;s:97:"C:\Users\Administrator\Desktop\Project\boot_cms\public/../application/admin\view\public\head.html";i:1505897340;s:96:"C:\Users\Administrator\Desktop\Project\boot_cms\public/../application/admin\view\public\css.html";i:1505702521;s:95:"C:\Users\Administrator\Desktop\Project\boot_cms\public/../application/admin\view\public\js.html";i:1505702521;}*/ ?>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertAdvert" action="<?php echo url('Advert/update_advert'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入标题" name="title" id="title" value="<?php echo $advert['title']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="输入外部链接" name="url" id="url" value="<?php echo $advert['url']; ?>">
                                <input type="hidden"  name="id" value="<?php echo $advert['id']; ?>" />
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">广告组：</label>

                            <div class="col-sm-4">
                                <select class="form-control m-b" name="cate_id" id="cate_id">
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$list): if($advert['cate_id'] == $list['id']): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="photo" value="<?php if(empty($advert['photo']) || (($advert['photo'] instanceof \think\Collection || $advert['photo'] instanceof \think\Paginator ) && $advert['photo']->isEmpty())): ?>/static/webupload/no_img.jpg<?php else: ?><?php echo $advert['photo']; endif; ?>">
                                <div id="fileList" class="uploader-list" style="float:right"></div>
                                <div id="imgPicker" style="float:left">选择图片</div>
                                <img id="img_data" height="100px" style="float:left;margin-left: 80px;margin-top: -10px;" src="
                                   <?php if(empty($advert['photo']) || (($advert['photo'] instanceof \think\Collection || $advert['photo'] instanceof \think\Paginator ) && $advert['photo']->isEmpty())): ?>
                                /static/webupload/no_img.jpg
                                <?php else: ?>
                                /uploads/images/<?php echo $advert['photo']; endif; ?>
                                "/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    $(function () {
        ...
        $('#insertAdvert').ajaxForm(opt);

        function insertBefor(){
            if ($('#title').val() == ''){
                layer.msg('广告标题不能为空',{icon:5});
                return false;
            }
        ...
        function insertOk(data){
            if (data.pass == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('Advert/list_advert'); ?>";
                });
            }else{
