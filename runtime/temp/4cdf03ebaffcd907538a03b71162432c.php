        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" id="insertAdvert" action="<?php echo url('Advert/insertAdvert'); ?>" enctype="multipart/form-data">
        ...
        function insertOk(data){
            if (data.pass == 1){
                layer.msg(data.msg, {icon: 6,time:1500,shade: 0.1}, function(index){
                    window.location.href="<?php echo url('Advert/listAdvert'); ?>";
                });
            }else{
