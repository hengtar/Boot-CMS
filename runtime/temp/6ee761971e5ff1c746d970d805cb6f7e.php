<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/data/wwwroot/default/thinkphp/public/../application/admin/view/member/list_cate.html";i:1503989205;s:80:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/head.html";i:1503989206;s:79:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/css.html";i:1503989206;s:78:"/data/wwwroot/default/thinkphp/public/../application/admin/view/public/js.html";i:1503989206;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('Member/insert_cate'); ?>"><button class="btn btn-outline btn-success" type="button">添加类型</button></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="example">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="lzCenter-td">
                            ...
                            <td>
                                <a href="<?php echo url('Member/update_cate',array('id' => $list['id'])); ?>" class="btn btn-success btn-outline btn-xs">
   ...
   $(function(){
       ...
       $('.laozhang').click(function(){
           ...
           layer.confirm('确认删除此分类?',
               {icon: 3, title:'提示'},
               function(index){$.getJSON("<?php echo url('Member/delete_cate'); ?>",
       ...
       $('.status').click(function(){
           ...
           layer.confirm('确认更改此分类?',
               {icon: 3, title:'提示'},
               function(index){$.getJSON("<?php echo url('Member/status_cate'); ?>",
